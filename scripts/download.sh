...
wget http://downloads.emolecules.com/free/2024-04-01/version.smi.gz -O emolecules_plus.smi.gz
wget http://downloads.emolecules.com/orderbb/2024-04-01/version.smi.gz -O emolecules_orderbb.smi.gz
gunzip *.gz
